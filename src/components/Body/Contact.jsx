            ...
            <div className="contact font-poppins my-5 px-10">
                ...
                <div className="info flex flex-col justify-between my-8 md:flex-row-reverse">
                        ...
                        >
                            ...
                            <div className="message my-4">
                                ...
                                <textarea
                                    ...
                                    value={message}
                                    className="rounded-2xl px-5 py-3 border border-gray-500 w-full"></textarea>
                            </div>
                            <div className="submit my-3">
                                <button 
                                    type="submit" 
                                    onSubmit={handleSubmit}
                                    className="bg bg-thickred px-5 py-2 text-white rounded-2xl"
                                >
                                    Submit
                                </button>
                            </div>
                    ...
                    <div className="details md:w-2/5">
                        ...
                        <p className="my-4">
                            Send us a message using the form on this page, or connect with us via the contact info below.
                        </p>
                        <div className="border-t-2 border-b-2 border-opacity-75">
                            <ul className="my-5">
                                <li className="flex">
